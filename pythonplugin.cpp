...
AMX_NATIVE_INFO HelloWorldNatives[ ] =
{
	...
	{ "pyOnPlayerClickTextDraw", n_OnPlayerClickTextDraw },
	{ "pyOnPlayerClickPlayerTextDraw", n_OnPlayerClickPlayerTextDraw },
	...
	{ "pyOnPlayerEditObject", n_OnPlayerEditObject },
	{ "pyOnPlayerEditAttachedObject", n_OnPlayerEditAttachedObject },
	...
	{ "pyOnPlayerSelectObject", n_OnPlayerSelectObject },
...
PLUGIN_EXPORT int PLUGIN_CALL AmxUnload( AMX *amx ) 
{
	...
	unsigned long long GetTickCount()
	{
		...
		return (tv.tv_sec * 1000) + (tv.tv_usec / 1000ULL);
	}
#endif
